...
- State the accountability rule explicitly in team onboarding: "You own every line of code in your PRs, regardless of how it was generated. AI-generated code is your code once you submit it." This framing should be in writing, not just verbal — it needs to be something engineers can refer back to.[^3]
...
**Description:** Sonar's research found that 96% of developers report distrust of AI-generated code quality — but only 48% report consistently verifying it before shipping.[^7] The gap between stated distrust and actual verification behavior is the clearest empirical signal of the security risk AI adoption creates for teams that have not explicitly addressed it. An engineer who distrusts AI output but ships it without verification is not exercising the accountability the role requires. They are gambling that the code is correct despite their own stated concerns about it.
...
[^3]: Gartner — "Predicts 2026: Software Engineering and DevSecOps," Gartner Research, January 2026. https://www.gartner.com/en/documents/predicts-2026-software-engineering-devsecops
    PR authorship as accountability event: how employment law and organizational policy converge on the engineer as the responsible party for AI-generated code; implications for security governance.
...
[^7]: The Pragmatic Engineer — "AI Tooling for Software Engineers in 2026," March 2026. https://newsletter.pragmaticengineer.com/p/ai-tooling-2026
    Sonar's 96%/48% finding: the verification gap between stated distrust and actual behavior; security calibration exercises as the practical intervention for closing this gap.
