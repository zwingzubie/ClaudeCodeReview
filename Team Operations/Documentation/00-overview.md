...
- Require runbook review as part of the PR merge criteria for any AI-primary PR that modifies deployment, data migration, infrastructure configuration, or other operationally significant components. The PR author attests that affected runbooks have been updated or that no runbooks are affected.
