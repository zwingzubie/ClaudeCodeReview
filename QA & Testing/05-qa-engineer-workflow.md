...
- Review the QA section of CLAUDE.md quarterly at the monthly AI practice review: are the entries current? Do they reflect the team's current failure mode profile? Entries for modules that have been deprecated or significantly refactored should be updated or removed — stale CLAUDE.md context is worse than no context because it generates tests for a system that no longer exists.[^1]
...
[^1]: Addy Osmani — "The Productivity Paradox of AI Coding Tools," addyosmani.com, April 2026. https://addyosmani.com/blog/ai-productivity-paradox
    QA repositioning in AI-assisted teams: the quality gate role as an elevation rather than a reduction; judgment-intensive QA activities as the irreplaceable complement to AI test generation.
