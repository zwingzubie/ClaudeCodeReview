...
[^a]: [Tooling: MCP Integration](../Tooling & Configuration/03-mcp-integration.md) — MCP integration covers the general configuration discipline; this document applies it to database server implementations.
...
[^d]: [Tooling: Settings and Permissions](../Tooling & Configuration/05-settings-and-permissions.md) — database MCP permission scoping controls what Claude Code can query and modify; permission configuration for database servers requires particular care.
